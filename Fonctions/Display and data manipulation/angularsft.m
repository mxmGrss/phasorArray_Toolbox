...
%                  If no complete revolution exists, istart=N+1.
...
% k=1 may already bracket a valid antecedent; use phase coverage itself.
istart = find(theta >= theta(1)+2*pi, 1, 'first');
if isempty(istart)
    istart = numel(theta)+1;
