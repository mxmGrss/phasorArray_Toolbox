...
%
%   This is a local copy of the PhasorArray Toolbox version, with the strict
%   monotonicity validator relaxed to a warning (TH may have a flat transient
%   at the start before the machine reaches steady speed).
%
