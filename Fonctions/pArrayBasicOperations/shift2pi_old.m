function [UHat, istart, i_first_rev, thetaHat, timeHat, L, F, IDX] = shift2pi_old(theta, time, U, optargin)
...
function [UHat, thetaHat, timeHat] = generateShiftedOutputs(theta, time, U, istart, angularShift)
    ...
    if ~isempty(U)
        try
            ...
            UHat = interp1(thetaMonotonic, UMonotonic', shiftedTheta)';
    ...
    try
        timeHat = interp1(thetaMonotonic, timeMonotonic, shiftedTheta);
