...
fprintf('To verify the installation, you can <a href="matlab:run_all_tests(''install'')">Run Install Tests</a> or <a href="matlab:run_all_tests()">Run All Global Tests</a>\n');
